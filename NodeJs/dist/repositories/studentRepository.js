...
var findByEmailAndPassword = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, student_1.default.findOne({ email: email, password: password })];
...
var findById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, student_1.default.findById(id)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
var saveStudent = function (student) { return __awaiter(void 0, void 0, void 0, function () {
    var newStudent;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                newStudent = new student_1.default(student);
