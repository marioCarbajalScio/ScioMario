...
//Crear Usuario
exports.userController.post('/', checkToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, userRepository_1.default.deletePost(user)];
            case 2:
                del = _a.sent();
